...
urlpatterns = patterns('',
    ...
    url(r'^signup/social$', user_views.social_user_new, name='social_user_new'),
    ...
    url(r'^userevent/(?P<pk>\d+)/edit/', views.userevent_edit, name='userevent_edit'),
    url(r'^userevent/(?P<pk>\d+)/verify/', views.userevent_verify, name='userevent_verify'),
