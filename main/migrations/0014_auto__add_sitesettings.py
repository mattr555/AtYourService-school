...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_sitesettings', (
            ...
            ('site', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['sites.Site'], related_name='settings')),
            ('service_hours', self.gf('django.db.models.fields.IntegerField')()),
            ('leadership_hours', self.gf('django.db.models.fields.IntegerField')()),
        ))
